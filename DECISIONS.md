...
- Comprehensive regression protection (186 automated tests across 16 test files, including dedicated bug regression suite `tests/test_bug_regression.py` and data contract suite `tests/test_data_contracts.py`).
